...
string Valid_Words[78] = {"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""};

int ValidWords_Size = 0;
int String_Size = 0;

String_Size = sizeof(string);
ValidWords_Size = sizeof(Valid_Words);

cout << String_Size << endl;
cout << (ValidWords_Size) / (String_Size) << endl;
...
Valid_Words[22] = ABA;
Valid_Words[23] = ABAC;
Valid_Words[24] = ABACA;
Valid_Words[25] = ABACAS;
Valid_Words[26] = ABACI;
Valid_Words[27] = ABACK;
Valid_Words[28] = ABACS;
Valid_Words[29] = ABACTERIAL;
Valid_Words[30] = ABACTINAL;
Valid_Words[31] = ABACTINALLY;
Valid_Words[32] = ABACTOR;
Valid_Words[33] = ABACTORS;
Valid_Words[34] = ABACUS;
Valid_Words[35] = ABACUSES;
Valid_Words[36] = ABAFT;
Valid_Words[37] = ABAKA;
Valid_Words[38] = ABAKAS;
Valid_Words[39] = ABALONE;
Valid_Words[40] = ABALONES;
Valid_Words[41] = ABAMP;
Valid_Words[42] = ABAMPERE;
Valid_Words[43] = ABAMPERES;
Valid_Words[44] = ABAMPS;
